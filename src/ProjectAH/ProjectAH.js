  ...
  render() {
    ...
    return(
      <div className="projectContainer">
        ...
        <div className="row">
          <div className="col5 marginRight"><img src={require("./../assets/img/AH/prototype-choose-filter.gif")} className="prototypeImg"/></div>
          <div className="col5 verticalCenter"><h2 className="title">Choose preset</h2>
          This option allows user to choose preferred preset without entering the list view. The app
